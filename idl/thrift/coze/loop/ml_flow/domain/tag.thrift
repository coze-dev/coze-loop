...
struct TagInfo {
    ...
    3: optional i64 spaceID (agw.js_conv="str")
    4: optional i32 versionNum                              // 数字版本号
    5: optional string version                              // SemVer 三段式版本号
    6: optional i64 tagKeyID (agw.js_conv="str")            // tag key id
    ...
    11: optional i64 parentTagKeyID (agw.js_conv="str")
    ...
    102: optional i64 createdAt (agw.js_conv="str")
    103: optional string updatedBy
    104: optional i64 updatedAt (agw.js_conv="str")
}

struct TagValue {
    1: optional i64 ID (agw.js_conv="str")                  // 创建时不传
    2: optional i32 appID                                   // 创建时不传
    3: optional i64 spaceID (agw.js_conv="str")             // 创建时不传
    4: optional i64 tagKeyID (agw.js_conv="str")            // 创建时不传
    5: optional i64 tagValueID (agw.js_conv="str")          // 创建时不传
