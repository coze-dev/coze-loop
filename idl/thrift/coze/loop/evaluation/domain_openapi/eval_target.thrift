...
const EvalTargetType EvalTargetType_A2Agent = "a2a_agent"
const EvalTargetType EvalTargetType_CustomAgent = "custom_agent"
const EvalTargetType EvalTargetType_SandboxAgent = "sandbox_agent"
...
// 单沙箱执行链路
const SandboxCountMode SandboxCountMode_Single = "single"
// 先起从属沙箱拿 session id，再起主沙箱运行 sandbox-pipeline
const SandboxCountMode SandboxCountMode_Dual = "dual"
...
struct SandboxAgent {
    ...
    9: optional SandboxCountMode sandbox_count_mode
}
