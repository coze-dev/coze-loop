...
struct ListEvaluatorsRequest {
    ...
    2: optional string search_name
    3: optional list<i64> creator_ids (api.js_conv='true', go.tag='json:"creator_ids"')
    4: optional list<evaluator.EvaluatorType> evaluator_type
    5: optional bool with_version

    11: optional bool builtin // 是否查询预置评估器
    12: optional evaluator.EvaluatorFilterOption filter_option (go.tag='json:"filter_option"') // 筛选器选项

    101: optional i32 page_size (vt.gt='0')
    102: optional i32 page_number (vt.gt='0')
...
struct ListEvaluatorsResponse {
    1: optional list<evaluator.Evaluator> evaluators (go.tag='json:"evaluators"')
    10: optional i64 total (api.js_conv='true', go.tag='json:"total"')
    255: base.BaseResp BaseResp
}

struct BatchGetEvaluatorsRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"')
    2: optional list<i64> evaluator_ids (api.js_conv='true', go.tag='json:"evaluator_ids"')
    3: optional bool include_deleted // 是否查询已删除的评估器，默认不查询
...
struct CreateEvaluatorRequest {
    1: required evaluator.Evaluator evaluator
...
struct UpdateEvaluatorDraftRequest {
    ...
    2: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"')  // 空间 id
    3: required evaluator.EvaluatorContent evaluator_content (go.tag='json:"evaluator_content"')
    4: required evaluator.EvaluatorType evaluator_type (go.tag='json:"evaluator_type"')
...
struct UpdateEvaluatorRequest {
    1: required i64 evaluator_id (api.path='evaluator_id', api.js_conv='true', go.tag='json:"evaluator_id"')  // 评估器 id
    2: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"')  // 空间 id
    3: required evaluator.EvaluatorType evaluator_type (go.tag='json:"evaluator_type"')
    4: optional string name (go.tag='json:"name"') // 展示用名称
    5: optional string description (go.tag='json:"description"') // 描述

    11: optional bool builtin (go.tag = 'json:"builtin"') // 是否预置评估器
    12: optional evaluator.EvaluatorInfo evaluator_info (go.tag = 'json:"evaluator_info"')
    13: optional string builtin_visible_version (go.tag = 'json:"builtin_visible_version"')
    14: optional evaluator.EvaluatorBoxType box_type (go.tag = 'json:"box_type"')
...
struct ListEvaluatorVersionsRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"')
    2: optional i64 evaluator_id (api.path='evaluator_id', api.js_conv='true', go.tag='json:"evaluator_id"')
    3: optional list<string> query_versions
    101: optional i32 page_size (vt.gt='0')
    102: optional i32 page_number (vt.gt='0')
    103: optional list<common.OrderBy> order_bys
...
struct ListEvaluatorVersionsResponse {
    1: optional list<evaluator.EvaluatorVersion> evaluator_versions
    10: optional i64 total (api.js_conv='true', go.tag='json:"total"')
...
struct GetEvaluatorVersionRequest {
    ...
    3: optional bool include_deleted // 是否查询已删除的评估器，默认不查询
    4: optional bool builtin (go.tag = 'json:"builtin"') // 是否预置评估器
...
struct BatchGetEvaluatorVersionsRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"')
    2: optional list<i64> evaluator_version_ids (api.js_conv='true', go.tag='json:"evaluator_version_ids"')
    3: optional bool include_deleted // 是否查询已删除的评估器，默认不查询
...
struct ListTemplatesRequest {
    1: required evaluator.TemplateType builtin_template_type

    255: optional base.Base Base
}

struct ListTemplatesResponse {
    1: optional list<evaluator.EvaluatorContent> builtin_template_keys
...
struct GetTemplateInfoRequest {
    1: required evaluator.TemplateType builtin_template_type
    2: required string builtin_template_key
    3: optional evaluator.LanguageType language_type // code评估器默认python

    255: optional base.Base Base
}

struct GetTemplateInfoResponse {
    1: optional evaluator.EvaluatorContent evaluator_content

    255: base.BaseResp BaseResp
}

struct RunEvaluatorRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"') // 空间 id
    ...
    3: required evaluator.EvaluatorInputData input_data         // 评测数据输入: 数据集行内容 + 评测目标输出内容与历史记录 + 评测目标的 trace
    4: optional i64 experiment_id (api.js_conv='true', go.tag='json:"experiment_id"')                          // experiment id
    5: optional i64 experiment_run_id (api.js_conv='true', go.tag='json:"experiment_run_id"')                          // experiment run id
    6: optional i64 item_id (api.js_conv='true', go.tag='json:"item_id"')
    7: optional i64 turn_id (api.js_conv='true', go.tag='json:"turn_id"')

    11: optional evaluator.EvaluatorRunConfig evaluator_run_conf // 评估器运行配置参数
...
struct DebugEvaluatorRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"') // 空间 id
    2: required evaluator.EvaluatorContent evaluator_content                     // 待调试评估器内容
    3: required evaluator.EvaluatorInputData input_data         // 评测数据输入: 数据集行内容 + 评测目标输出内容与历史记录 + 评测目标的 trace
    4: required evaluator.EvaluatorType evaluator_type (go.tag='json:"evaluator_type"')
...
struct BatchDebugEvaluatorRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"') // 空间 id
    2: required evaluator.EvaluatorContent evaluator_content                     // 待调试评估器内容
    3: required list<evaluator.EvaluatorInputData> input_data         // 评测数据输入: 数据集行内容 + 评测目标输出内容与历史记录 + 评测目标的 trace
    4: required evaluator.EvaluatorType evaluator_type (go.tag='json:"evaluator_type"')
...
struct BatchDebugEvaluatorResponse {
    1: optional list<evaluator.EvaluatorOutputData> evaluator_output_data // 输出数据
...
struct CheckEvaluatorNameRequest {
    ...
    3: optional i64 evaluator_id (api.js_conv='true', go.tag='json:"evaluator_id"')
...
struct ListEvaluatorRecordResponse {
    1: required list<evaluator.EvaluatorRecord> records
...
struct GetEvaluatorRecordRequest {
    ...
    3: optional bool include_deleted // 是否查询已删除的，默认不查询
...
struct BatchGetEvaluatorRecordsRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"')
    2: optional list<i64> evaluator_record_ids (api.js_conv='true', go.tag='json:"evaluator_record_ids"')
    3: optional bool include_deleted // 是否查询已删除的，默认不查询
...
struct UpdateEvaluatorRecordRequest {
    1: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"')
    2: required i64 evaluator_record_id (api.path='evaluator_record_id', api.js_conv='true', go.tag='json:"evaluator_record_id"')
    3: required evaluator.Correction correction
...
struct GetDefaultPromptEvaluatorToolsResponse {
    1: required list<evaluator.Tool> tools
...
struct ValidateEvaluatorRequest {
    ...
    3: required evaluator.EvaluatorType evaluator_type (go.tag='json:"evaluator_type"')
    4: optional evaluator.EvaluatorInputData input_data
...
struct ValidateEvaluatorResponse {
    ...
    3: optional evaluator.EvaluatorOutputData evaluator_output_data

    255: base.BaseResp BaseResp
}

struct ListTemplatesV2Request {
    1: optional evaluator.EvaluatorFilterOption filter_option (go.tag='json:"filter_option"') // 筛选器选项
...
struct ListTemplatesV2Response {
    1: optional list<evaluator.EvaluatorTemplate> evaluator_templates
...
struct GetTemplateV2Request {
    ...
    2: optional bool custom_code // 是否查询自定义code评估器模板，默认不查询

    255: optional base.Base Base
}

struct GetTemplateV2Response {
    1: optional evaluator.EvaluatorTemplate evaluator_template
...
struct DebugBuiltinEvaluatorRequest {
    ...
    2: required evaluator.EvaluatorInputData input_data
    3: required i64 workspace_id (api.js_conv='true', go.tag='json:"workspace_id"') // 空间 id

    255: optional base.Base Base
}

struct DebugBuiltinEvaluatorResponse {
    1: required evaluator.EvaluatorOutputData output_data
...
struct UpdateBuiltinEvaluatorTagsRequest {
    ...
    3: optional map<evaluator.EvaluatorTagLangType, map<evaluator.EvaluatorTagKey, list<string>>> tags (go.tag = 'json:"tags"') // 评估器标签
...
struct CreateEvaluatorTemplateRequest {
    1: required evaluator.EvaluatorTemplate evaluator_template
    255: optional base.Base Base
}
...
struct UpdateEvaluatorTemplateRequest {
    ...
    2: required evaluator.EvaluatorTemplate evaluator_template
    255: optional base.Base Base
}
...
struct ListEvaluatorTagsRequest {
    1: optional evaluator.EvaluatorTagType tag_type (go.tag='json:"tag_type"') // 评估器标签类型，默认预置评估器

    255: optional base.Base Base
}

struct ListEvaluatorTagsResponse {
    1: optional map<evaluator.EvaluatorTagKey, list<string>> tags // 筛选器选项
