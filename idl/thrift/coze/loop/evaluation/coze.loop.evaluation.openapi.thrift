...
service EvaluationOpenAPIService {
    ...
    // 评估器接口
    // 查询评估器列表
    ListEvaluatorsOApiResponse ListEvaluatorsOApi(1: ListEvaluatorsOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluators/list")
    // 批量查询评估器
    BatchGetEvaluatorsOApiResponse BatchGetEvaluatorsOApi(1: BatchGetEvaluatorsOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluators/batch_get")
    // 创建评估器
    CreateEvaluatorOApiResponse CreateEvaluatorOApi(1: CreateEvaluatorOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluators")
    // 更新评估器
    UpdateEvaluatorOApiResponse UpdateEvaluatorOApi(1: UpdateEvaluatorOApiRequest req) (api.tag="openapi", api.patch = "/v1/loop/evaluation/evaluators/:evaluator_id")
    // 更新评估器草稿
    UpdateEvaluatorDraftOApiResponse UpdateEvaluatorDraftOApi(1: UpdateEvaluatorDraftOApiRequest req) (api.tag="openapi", api.patch = "/v1/loop/evaluation/evaluators/:evaluator_id/update_draft")
    // 删除评估器
    DeleteEvaluatorOApiResponse DeleteEvaluatorOApi(1: DeleteEvaluatorOApiRequest req) (api.tag="openapi", api.delete = "/v1/loop/evaluation/evaluators/:evaluator_id")
    // 查询评估器版本列表
    ListEvaluatorVersionsOApiResponse ListEvaluatorVersionsOApi(1: ListEvaluatorVersionsOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluators/:evaluator_id/versions/list")
    // 批量查询评估器版本
    BatchGetEvaluatorVersionsOApiResponse BatchGetEvaluatorVersionsOApi(1: BatchGetEvaluatorVersionsOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluators_versions/batch_get")
    // 提交评估器版本
    SubmitEvaluatorVersionOApiResponse SubmitEvaluatorVersionOApi(1: SubmitEvaluatorVersionOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluators/:evaluator_id/submit_version")
    // 执行评估器
    RunEvaluatorOApiResponse RunEvaluatorOApi(1: RunEvaluatorOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluators_versions/:evaluator_version_id/run")
    // 修正评估记录
    CorrectEvaluatorRecordOApiResponse CorrectEvaluatorRecordOApi(1: CorrectEvaluatorRecordOApiRequest req) (api.tag="openapi", api.patch = "/v1/loop/evaluation/evaluator_records/:evaluator_record_id")
    // 批量查询评估记录
    BatchGetEvaluatorRecordsOApiResponse BatchGetEvaluatorRecordsOApi(1: BatchGetEvaluatorRecordsOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/evaluator_records/batch_get")

    // 实验模板接口
    // 创建实验模板
    CreateExptTemplateOApiResponse CreateExptTemplateOApi(1: CreateExptTemplateOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/experiment_templates")
    // 批量查询实验模板
    BatchGetExptTemplatesOApiResponse BatchGetExptTemplatesOApi(1: BatchGetExptTemplatesOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/experiment_templates/batch_get")
    // 更新实验模板元信息
    UpdateExptTemplateMetaOApiResponse UpdateExptTemplateMetaOApi(1: UpdateExptTemplateMetaOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/experiment_templates/update_meta")
    // 更新实验模板
    UpdateExptTemplateOApiResponse UpdateExptTemplateOApi(1: UpdateExptTemplateOApiRequest req) (api.tag="openapi", api.patch = "/v1/loop/evaluation/experiment_templates/:template_id")
    // 删除实验模板
    DeleteExptTemplateOApiResponse DeleteExptTemplateOApi(1: DeleteExptTemplateOApiRequest req) (api.tag="openapi", api.delete = "/v1/loop/evaluation/experiment_templates/:template_id")
    // 查询实验模板列表
    ListExptTemplatesOApiResponse ListExptTemplatesOApi(1: ListExptTemplatesOApiRequest req) (api.tag="openapi", api.post = "/v1/loop/evaluation/experiment_templates/list")
}
