...
struct SubmitExperimentOApiRequest {
    ...
    // 通知配置
    50: optional list<experiment.NotificationConfig> notifications (api.body = 'notifications')
...
struct CreateExptTemplateOApiRequest {
    ...
    // 通知配置
    30: optional list<experiment.NotificationConfig> notifications (api.body='notifications')
