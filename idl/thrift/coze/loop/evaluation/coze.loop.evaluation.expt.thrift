...
struct CreateExperimentRequest {
    ...
    // 通知配置
    110: optional list<expt.NotificationConfig> notifications (api.body = 'notifications')
...
struct CreateExperimentTemplateRequest {
    ...
    // 通知配置
    40: optional list<expt.NotificationConfig> notifications (api.body = 'notifications')
