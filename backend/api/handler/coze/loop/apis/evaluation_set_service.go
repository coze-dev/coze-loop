...
// @router /api/evaluation/v1/evaluation_sets/:evaluation_set_id/items/batch_upsert_columns [POST]
func BatchUpsertEvaluationSetItemColumns(ctx context.Context, c *app.RequestContext) {
	var err error
	var req eval_set.BatchUpsertEvaluationSetItemColumnsRequest
	...
	resp := new(eval_set.BatchUpsertEvaluationSetItemColumnsResponse)
