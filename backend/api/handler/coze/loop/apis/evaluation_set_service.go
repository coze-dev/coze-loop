...
// GetEvaluationSetsCount .
// @router /api/evaluation/v1/evaluation_sets/count [POST]
func GetEvaluationSetsCount(ctx context.Context, c *app.RequestContext) {
	var err error
	var req eval_set.GetEvaluationSetsCountRequest
	...
	resp := new(eval_set.GetEvaluationSetsCountResponse)
