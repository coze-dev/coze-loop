...
//
//	mockgen -destination=modules/evaluation/domain/repo/mocks/target.go -package=mocks github.com/coze-dev/coze-loop/backend/modules/evaluation/domain/repo IEvalTargetRepo
//
