...
func (m *MockIExperimentRepo) ExistGroupKey(ctx context.Context, groupKey string, spaceID int64) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExistGroupKey", ctx, groupKey, spaceID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIExperimentRepoMockRecorder) ExistGroupKey(ctx, groupKey, spaceID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExistGroupKey", reflect.TypeOf((*MockIExperimentRepo)(nil).ExistGroupKey), ctx, groupKey, spaceID)
}
...
func (m *MockIExperimentRepo) GetIDsByGroupKey(ctx context.Context, spaceID int64, groupKey string, page, pageSize int32) ([]int64, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetIDsByGroupKey", ctx, spaceID, groupKey, page, pageSize)
	ret0, _ := ret[0].([]int64)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockIExperimentRepoMockRecorder) GetIDsByGroupKey(ctx, spaceID, groupKey, page, pageSize any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetIDsByGroupKey", reflect.TypeOf((*MockIExperimentRepo)(nil).GetIDsByGroupKey), ctx, spaceID, groupKey, page, pageSize)
}
...
func (m *MockIExptItemResultRepo) CountItemsByStatus(ctx context.Context, spaceID, exptID int64) (map[entity.ItemRunState]int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountItemsByStatus", ctx, spaceID, exptID)
	ret0, _ := ret[0].(map[entity.ItemRunState]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountItemsByStatus indicates an expected call of CountItemsByStatus.
func (mr *MockIExptItemResultRepoMockRecorder) CountItemsByStatus(ctx, spaceID, exptID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIExptTurnResultRepo) ApplyItemRunResults(ctx context.Context, exptID, exptRunID, itemID, spaceID int64, turnResults []*entity.ExptTurnResult, refs []*entity.ExptTurnEvaluatorResultRef) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApplyItemRunResults", ctx, exptID, exptRunID, itemID, spaceID, turnResults, refs)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIExptTurnResultRepoMockRecorder) ApplyItemRunResults(ctx, exptID, exptRunID, itemID, spaceID, turnResults, refs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyItemRunResults", reflect.TypeOf((*MockIExptTurnResultRepo)(nil).ApplyItemRunResults), ctx, exptID, exptRunID, itemID, spaceID, turnResults, refs)
}
...
func (m *MockIExptItemRefRepo) BatchCreate(ctx context.Context, items []*entity.ExptItemRef) error {
	m.ctrl.T.Helper()
...
func (mr *MockIExptItemRefRepoMockRecorder) BatchCreate(ctx, items any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BatchCreate", reflect.TypeOf((*MockIExptItemRefRepo)(nil).BatchCreate), ctx, items)
}

// CountByEvalSetGrouped mocks base method.
func (m *MockIExptItemRefRepo) CountByEvalSetGrouped(ctx context.Context, spaceID int64, exptIDs []int64) (map[int64][]*entity.ExptEvalSetItemCount, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountByEvalSetGrouped", ctx, spaceID, exptIDs)
...
func (mr *MockIExptItemRefRepoMockRecorder) CountByEvalSetGrouped(ctx, spaceID, exptIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountByEvalSetGrouped", reflect.TypeOf((*MockIExptItemRefRepo)(nil).CountByEvalSetGrouped), ctx, spaceID, exptIDs)
}

// GetByExptIDAndItemID mocks base method.
func (m *MockIExptItemRefRepo) GetByExptIDAndItemID(ctx context.Context, spaceID, exptID, itemID int64) (*entity.ExptItemRef, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByExptIDAndItemID", ctx, spaceID, exptID, itemID)
...
func (mr *MockIExptItemRefRepoMockRecorder) GetByExptIDAndItemID(ctx, spaceID, exptID, itemID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByExptIDAndItemID", reflect.TypeOf((*MockIExptItemRefRepo)(nil).GetByExptIDAndItemID), ctx, spaceID, exptID, itemID)
}

// ListByExptID mocks base method.
func (m *MockIExptItemRefRepo) ListByExptID(ctx context.Context, spaceID, exptID, cursor, limit int64) ([]*entity.ExptItemRef, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByExptID", ctx, spaceID, exptID, cursor, limit)
	ret0, _ := ret[0].([]*entity.ExptItemRef)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockIExptItemRefRepoMockRecorder) ListByExptID(ctx, spaceID, exptID, cursor, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByExptID", reflect.TypeOf((*MockIExptItemRefRepo)(nil).ListByExptID), ctx, spaceID, exptID, cursor, limit)
}

// MGetByExptIDAndItemIDs mocks base method.
func (m *MockIExptItemRefRepo) MGetByExptIDAndItemIDs(ctx context.Context, spaceID, exptID int64, itemIDs []int64) ([]*entity.ExptItemRef, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MGetByExptIDAndItemIDs", ctx, spaceID, exptID, itemIDs)
	ret0, _ := ret[0].([]*entity.ExptItemRef)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIExptItemRefRepoMockRecorder) MGetByExptIDAndItemIDs(ctx, spaceID, exptID, itemIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MGetByExptIDAndItemIDs", reflect.TypeOf((*MockIExptItemRefRepo)(nil).MGetByExptIDAndItemIDs), ctx, spaceID, exptID, itemIDs)
}
