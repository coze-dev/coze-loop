...
// GetByRunID mocks base method.
func (m *MockIExptRunLogRepo) GetByRunID(ctx context.Context, exptRunID int64) (*entity.ExptRunLog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByRunID", ctx, exptRunID)
	ret0, _ := ret[0].(*entity.ExptRunLog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetByRunID indicates an expected call of GetByRunID.
func (mr *MockIExptRunLogRepoMockRecorder) GetByRunID(ctx, exptRunID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByRunID", reflect.TypeOf((*MockIExptRunLogRepo)(nil).GetByRunID), ctx, exptRunID)
}
