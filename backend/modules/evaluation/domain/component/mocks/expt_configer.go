...
func (m *MockIConfiger) GetExptTurnScoreHookConf(ctx context.Context, spaceID, exptID int64, evaluatorVersionIDs []int64) (*entity.ExptTurnScoreHookConf, bool) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExptTurnScoreHookConf", ctx, spaceID, exptID, evaluatorVersionIDs)
...
func (mr *MockIConfigerMockRecorder) GetExptTurnScoreHookConf(ctx, spaceID, exptID, evaluatorVersionIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetExptTurnScoreHookConf", reflect.TypeOf((*MockIConfiger)(nil).GetExptTurnScoreHookConf), ctx, spaceID, exptID, evaluatorVersionIDs)
}
