...
//
//	mockgen -destination modules/evaluation/domain/events/mocks/expt_event_publisher_mock.go -package mocks github.com/coze-dev/coze-loop/backend/modules/evaluation/domain/events ExptEventPublisher
//
