...
func (m *MockExptEventPublisher) PublishWebhookDeliveryEvent(ctx context.Context, event *entity.WebhookDeliveryMessage, delay *time.Duration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PublishWebhookDeliveryEvent", ctx, event, delay)
	ret0, _ := ret[0].(error)
	return ret0
}

// PublishWebhookDeliveryEvent indicates an expected call of PublishWebhookDeliveryEvent.
func (mr *MockExptEventPublisherMockRecorder) PublishWebhookDeliveryEvent(ctx, event, delay any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PublishWebhookDeliveryEvent", reflect.TypeOf((*MockExptEventPublisher)(nil).PublishWebhookDeliveryEvent), ctx, event, delay)
}
