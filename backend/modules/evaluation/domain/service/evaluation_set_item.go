...
type EvaluationSetItemService interface {
	...
	// itemVersion / itemVersionDescription 透传 versioned_item 数据集的版本语义；为空表示更新 draft。
	UpdateEvaluationSetItem(ctx context.Context, spaceID, evaluationSetID, itemID int64, turns []*entity.Turn, fieldWriteOptions []*entity.FieldWriteOption, tags []*entity.ResourceTagRef, itemVersion, itemVersionDescription *string) (err error)
