...
// Source: github.com/coze-dev/coze-loop/backend/modules/evaluation/domain/service (interfaces: ISourceEvalTargetOperateService,LatestSourceVersionProvider)
...
func (mr *MockISourceEvalTargetOperateServiceMockRecorder) AsyncExecute(arg0, arg1, arg2 interface{}) *gomock.Call {
...
func (mr *MockISourceEvalTargetOperateServiceMockRecorder) SearchCustomEvalTarget(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// MockLatestSourceVersionProvider is a mock of LatestSourceVersionProvider interface.
type MockLatestSourceVersionProvider struct {
	ctrl     *gomock.Controller
	recorder *MockLatestSourceVersionProviderMockRecorder
}

// MockLatestSourceVersionProviderMockRecorder is the mock recorder for MockLatestSourceVersionProvider.
type MockLatestSourceVersionProviderMockRecorder struct {
	mock *MockLatestSourceVersionProvider
}

// NewMockLatestSourceVersionProvider creates a new mock instance.
func NewMockLatestSourceVersionProvider(ctrl *gomock.Controller) *MockLatestSourceVersionProvider {
	mock := &MockLatestSourceVersionProvider{ctrl: ctrl}
	mock.recorder = &MockLatestSourceVersionProviderMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockLatestSourceVersionProvider) EXPECT() *MockLatestSourceVersionProviderMockRecorder {
	return m.recorder
}

// GetLatestSourceVersion mocks base method.
func (m *MockLatestSourceVersionProvider) GetLatestSourceVersion(arg0 context.Context, arg1 int64, arg2 string) (*entity.EvalTargetVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLatestSourceVersion", arg0, arg1, arg2)
	ret0, _ := ret[0].(*entity.EvalTargetVersion)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLatestSourceVersion indicates an expected call of GetLatestSourceVersion.
func (mr *MockLatestSourceVersionProviderMockRecorder) GetLatestSourceVersion(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLatestSourceVersion", reflect.TypeOf((*MockLatestSourceVersionProvider)(nil).GetLatestSourceVersion), arg0, arg1, arg2)
}
