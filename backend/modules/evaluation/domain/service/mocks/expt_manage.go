...
func (m *MockIExptManager) InjectExptConfTimeRange(ctx context.Context, exptID int64, startTime, endTime *int64) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "InjectExptConfTimeRange", ctx, exptID, startTime, endTime)
}

// InjectExptConfTimeRange indicates an expected call of InjectExptConfTimeRange.
func (mr *MockIExptManagerMockRecorder) InjectExptConfTimeRange(ctx, exptID, startTime, endTime any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InjectExptConfTimeRange", reflect.TypeOf((*MockIExptManager)(nil).InjectExptConfTimeRange), ctx, exptID, startTime, endTime)
}
