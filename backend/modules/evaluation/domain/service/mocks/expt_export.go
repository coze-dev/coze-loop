...
func (m *MockIExptResultExportService) DoExportCSV(ctx context.Context, spaceID, exptID, exportID int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DoExportCSV", ctx, spaceID, exptID, exportID)
	ret0, _ := ret[0].(error)
	return ret0
}

// DoExportCSV indicates an expected call of DoExportCSV.
func (mr *MockIExptResultExportServiceMockRecorder) DoExportCSV(ctx, spaceID, exptID, exportID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DoExportCSV", reflect.TypeOf((*MockIExptResultExportService)(nil).DoExportCSV), ctx, spaceID, exptID, exportID)
}
