...
import (
	...
	service "github.com/coze-dev/coze-loop/backend/modules/evaluation/domain/service"
...
func (m *MockIEvaluationAnalysisService) TrajectoryAnalysis(ctx context.Context, param service.TrajectoryAnalysisParam) (int64, error) {
	m.ctrl.T.Helper()
