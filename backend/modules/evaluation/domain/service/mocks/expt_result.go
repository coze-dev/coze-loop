...
//
//	mockgen -destination ./mocks/expt_result.go --package mocks github.com/coze-dev/coze-loop/backend/modules/evaluation/domain/service ExptResultService,ExptAggrResultService
//
