...
//
//	mockgen -destination=modules/evaluation/domain/service/mocks/target.go -package=mocks github.com/coze-dev/coze-loop/backend/modules/evaluation/domain/service IEvalTargetService
//
