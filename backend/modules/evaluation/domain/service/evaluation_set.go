...
type IEvaluationSetService interface {
	...
	GetEvaluationSet(ctx context.Context, spaceID *int64, evaluationSetID int64, deletedAt *bool, sharedOption *entity.SharedResourceOption) (set *entity.EvaluationSet, err error)
	BatchGetEvaluationSets(ctx context.Context, spaceID *int64, evaluationSetID []int64, deletedAt *bool, sharedOption *entity.SharedResourceOption) (set []*entity.EvaluationSet, err error)
