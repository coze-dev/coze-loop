...
type IEvaluationSetService interface {
	...
	// CountEvaluationSets 统计空间内 item_count 严格大于阈值的评测集数量（透传 data 模块 Dataset count 能力）。
	CountEvaluationSets(ctx context.Context, param *entity.CountEvaluationSetsParam) (count int64, err error)
