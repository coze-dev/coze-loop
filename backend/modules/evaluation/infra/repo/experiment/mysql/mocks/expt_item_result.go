...
//
//	mockgen -destination=mocks/expt_item_result.go -package mocks github.com/coze-dev/coze-loop/backend/modules/evaluation/infra/repo/experiment/mysql IExptItemResultDAO
//
...
// CountItemsByBackflowStatus mocks base method.
func (m *MockIExptItemResultDAO) CountItemsByBackflowStatus(ctx context.Context, spaceID, exptID int64, opts ...db.Option) (map[int32]int64, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, spaceID, exptID}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CountItemsByBackflowStatus", varargs...)
	ret0, _ := ret[0].(map[int32]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountItemsByBackflowStatus indicates an expected call of CountItemsByBackflowStatus.
func (mr *MockIExptItemResultDAOMockRecorder) CountItemsByBackflowStatus(ctx, spaceID, exptID any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, spaceID, exptID}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountItemsByBackflowStatus", reflect.TypeOf((*MockIExptItemResultDAO)(nil).CountItemsByBackflowStatus), varargs...)
}
...
// ListItemIDsByBackflowStatus mocks base method.
func (m *MockIExptItemResultDAO) ListItemIDsByBackflowStatus(ctx context.Context, spaceID, exptID int64, backflowStatuses []int32, opts ...db.Option) ([]int64, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, spaceID, exptID, backflowStatuses}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ListItemIDsByBackflowStatus", varargs...)
	ret0, _ := ret[0].([]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListItemIDsByBackflowStatus indicates an expected call of ListItemIDsByBackflowStatus.
func (mr *MockIExptItemResultDAOMockRecorder) ListItemIDsByBackflowStatus(ctx, spaceID, exptID, backflowStatuses any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, spaceID, exptID, backflowStatuses}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListItemIDsByBackflowStatus", reflect.TypeOf((*MockIExptItemResultDAO)(nil).ListItemIDsByBackflowStatus), varargs...)
}
