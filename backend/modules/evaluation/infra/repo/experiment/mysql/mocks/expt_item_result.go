...
//
//	mockgen -destination=modules/evaluation/infra/repo/experiment/mysql/mocks/expt_item_result.go -package=mocks github.com/coze-dev/coze-loop/backend/modules/evaluation/infra/repo/experiment/mysql IExptItemResultDAO
//
...
func (m *MockIExptItemResultDAO) ClaimItemRunForSubmit(ctx context.Context, exptID, exptRunID, itemID, spaceID int64, expectedRetryTimes int32, opts ...db.Option) (bool, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ClaimItemRunForSubmit", varargs...)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIExptItemResultDAOMockRecorder) ClaimItemRunForSubmit(ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClaimItemRunForSubmit", reflect.TypeOf((*MockIExptItemResultDAO)(nil).ClaimItemRunForSubmit), varargs...)
}

// CountItemsByStatus mocks base method.
func (m *MockIExptItemResultDAO) CountItemsByStatus(ctx context.Context, spaceID, exptID int64, opts ...db.Option) (map[int32]int64, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, spaceID, exptID}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CountItemsByStatus", varargs...)
	ret0, _ := ret[0].(map[int32]int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountItemsByStatus indicates an expected call of CountItemsByStatus.
func (mr *MockIExptItemResultDAOMockRecorder) CountItemsByStatus(ctx, spaceID, exptID any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockIExptItemResultDAO) RollbackItemRunSubmit(ctx context.Context, exptID, exptRunID, itemID, spaceID int64, expectedRetryTimes int32, opts ...db.Option) (bool, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "RollbackItemRunSubmit", varargs...)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIExptItemResultDAOMockRecorder) RollbackItemRunSubmit(ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RollbackItemRunSubmit", reflect.TypeOf((*MockIExptItemResultDAO)(nil).RollbackItemRunSubmit), varargs...)
}
...
func (m *MockIExptItemResultDAO) YieldItemRunForRetry(ctx context.Context, exptID, exptRunID, itemID, spaceID int64, expectedRetryTimes int32, errMsg string, opts ...db.Option) (bool, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes, errMsg}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "YieldItemRunForRetry", varargs...)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockIExptItemResultDAOMockRecorder) YieldItemRunForRetry(ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes, errMsg any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, exptID, exptRunID, itemID, spaceID, expectedRetryTimes, errMsg}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "YieldItemRunForRetry", reflect.TypeOf((*MockIExptItemResultDAO)(nil).YieldItemRunForRetry), varargs...)
}
