...
func (ExptTemplateConverter) PO2DO(po *model.ExptTemplate, refs []*model.ExptTemplateEvaluatorRef) (*entity.ExptTemplate, error) {
	...
	var notificationConf *entity.NotificationConfig
	if po.NotificationConf != nil && *po.NotificationConf != "" {
		notificationConf = new(entity.NotificationConfig)
		if err := json.Unmarshal([]byte(*po.NotificationConf), notificationConf); err != nil {
