...
func (dr *DenoRuntime) RunCode(ctx context.Context, req *entity.SandboxExecutionRequest) (*entity.SandboxExecutionResult, error) {
	startTime := time.Now()
...
// executeCommand 执行命令
func (dr *DenoRuntime) executeCommand(ctx context.Context, cmd *exec.Cmd, startTime time.Time) (*entity.SandboxExecutionResult, error) {
	// 设置资源限制
	...
	result := &entity.SandboxExecutionResult{
		Duration: duration,
	}
