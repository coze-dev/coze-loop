...
func (a *DatasetRPCAdapter) GetDataset(ctx context.Context, spaceID *int64, evaluationSetID int64, deletedAt *bool, opt ...rpc.GetDatasetOpt) (set *entity.EvaluationSet, err error) {
