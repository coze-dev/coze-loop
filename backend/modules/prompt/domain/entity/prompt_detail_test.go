...
func Test_formatMultiPart(t *testing.T) {
	tests := []struct {
		name     string
		parts    []*ContentPart
		defMap   map[string]*VariableDef
		...
		{
			name: "non-multipart variable parts remain unchanged",
			parts: []*ContentPart{
				{
					Type: ContentTypeText,
					Text: ptr.Of("regular text"),
				},
				{
					Type:     ContentTypeImageURL,
					ImageURL: &ImageURL{URI: "image1"},
				},
			},
			defMap: nil,
			valMap: nil,
		...
		{
			name: "multipart variable with valid definition and value",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
				},
			},
			defMap: map[string]*VariableDef{
				"multivar1": {
					Key:  "multivar1",
					Type: VariableTypeMultiPart,
				},
			},
			valMap: map[string]*VariableVal{
				"multivar1": {
		...
		{
			name: "multipart variable with empty text",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of(""),
		...
		{
			name: "multipart variable not in value map",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
		...
		{
			name: "multipart variable with wrong type in definition",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
		...
		{
			name: "multipart variable with nil definition",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
		...
		{
			name: "multipart variable with nil value",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
		...
		{
			name: "multipart variable with empty MultiPartValues",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
		...
		{
			name: "multipart variable with nil MultiPartValues",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
		...
		{
			name: "mixed parts with multipart variable",
			parts: []*ContentPart{
				{
					Type: ContentTypeText,
					Text: ptr.Of("prefix text"),
				},
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
				...
				{
					Type:     ContentTypeImageURL,
					ImageURL: &ImageURL{URI: "suffix_image"},
				},
			},
			defMap: map[string]*VariableDef{
				"multivar1": {
			...
			valMap: map[string]*VariableVal{
				"multivar1": {
					...
					MultiPartValues: []*ContentPart{
						{
							Type: ContentTypeText,
							Text: ptr.Of("middle text"),
						},
						{
							Type:     ContentTypeImageURL,
							ImageURL: &ImageURL{URI: "middle_image"},
						},
					},
				},
			},
		...
		{
			name: "multiple multipart variables",
			parts: []*ContentPart{
				{
					Type: ContentTypeMultiPartVariable,
					Text: ptr.Of("multivar1"),
			...
			valMap: map[string]*VariableVal{
				...
				"multivar2": {
					...
					MultiPartValues: []*ContentPart{
						{
							Type:     ContentTypeImageURL,
							ImageURL: &ImageURL{URI: "second_image"},
						},
					},
				},
			},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := formatMultiPart(tt.parts, tt.defMap, tt.valMap)
			assert.Equal(t, tt.expected, result)
		})
	}
}

func TestVariableVal_MultiPartValues(t *testing.T) {
	tests := []struct {
		name     string
		val      *VariableVal
		expected []*ContentPart
		...
		{
			name: "MultiPartValues with content",
			val: &VariableVal{
				Key: "test",
				MultiPartValues: []*ContentPart{
					{
						Type: ContentTypeText,
						Text: ptr.Of("test text"),
					},
					{
						Type:     ContentTypeImageURL,
						ImageURL: &ImageURL{URI: "test_image"},
					},
				},
			},
			expected: []*ContentPart{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.expected, tt.val.MultiPartValues)
		})
	}
}
