...
func (m *MockIWorkSpaceProvider) ClipTableByWorkspace(ctx context.Context, workspaceID string, tables []string, isGetTraceByID bool, queryStartTimeMs int64) []string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ClipTableByWorkspace", ctx, workspaceID, tables, isGetTraceByID, queryStartTimeMs)
	ret0, _ := ret[0].([]string)
	return ret0
}

// ClipTableByWorkspace indicates an expected call of ClipTableByWorkspace.
func (mr *MockIWorkSpaceProviderMockRecorder) ClipTableByWorkspace(ctx, workspaceID, tables, isGetTraceByID, queryStartTimeMs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ClipTableByWorkspace", reflect.TypeOf((*MockIWorkSpaceProvider)(nil).ClipTableByWorkspace), ctx, workspaceID, tables, isGetTraceByID, queryStartTimeMs)
}
