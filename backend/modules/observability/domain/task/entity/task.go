...
type EvaluationExperimentConfig struct {
	...
	SourceTargetVersion      *string                 `json:"source_target_version,omitempty"`
	FullEvalSetFieldMappings []*EvaluateFieldMapping `json:"full_eval_set_field_mappings,omitempty"`
}
