...
func (m *MockITraceService) GetAdjacentTrace(ctx context.Context, req *service.GetAdjacentTraceRequest) (*service.GetAdjacentTraceResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAdjacentTrace", ctx, req)
	ret0, _ := ret[0].(*service.GetAdjacentTraceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAdjacentTrace indicates an expected call of GetAdjacentTrace.
func (mr *MockITraceServiceMockRecorder) GetAdjacentTrace(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAdjacentTrace", reflect.TypeOf((*MockITraceService)(nil).GetAdjacentTrace), ctx, req)
}
