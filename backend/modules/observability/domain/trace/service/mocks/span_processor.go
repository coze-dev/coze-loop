...
//
//	mockgen -destination=modules/observability/domain/trace/service/mocks/span_processor.go -package=mocks github.com/coze-dev/coze-loop/backend/modules/observability/domain/trace/service TraceFilterProcessorBuilder
//
