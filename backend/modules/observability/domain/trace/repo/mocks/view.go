...
func (m *MockIViewRepo) ListViews(ctx context.Context, workspaceID int64, userID string, scope int32) ([]*entity.ObservabilityView, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIViewRepoMockRecorder) ListViews(ctx, workspaceID, userID, scope any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListViews", reflect.TypeOf((*MockIViewRepo)(nil).ListViews), ctx, workspaceID, userID, scope)
}
