...
//
//	mockgen -destination=modules/observability/application/mocks/trace_application.go -package=mocks github.com/coze-dev/coze-loop/backend/modules/observability/application ITraceApplication
//
...
// GetAdjacentTrace mocks base method.
func (m *MockITraceApplication) GetAdjacentTrace(ctx context.Context, req *trace.GetAdjacentTraceRequest) (*trace.GetAdjacentTraceResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAdjacentTrace", ctx, req)
	ret0, _ := ret[0].(*trace.GetAdjacentTraceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAdjacentTrace indicates an expected call of GetAdjacentTrace.
func (mr *MockITraceApplicationMockRecorder) GetAdjacentTrace(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAdjacentTrace", reflect.TypeOf((*MockITraceApplication)(nil).GetAdjacentTrace), ctx, req)
}
...
func (m *MockITraceApplication) ListMetadata(ctx context.Context, req *trace.ListMetadataRequest) (*trace.ListMetadataResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListMetadata", ctx, req)
	ret0, _ := ret[0].(*trace.ListMetadataResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListMetadata indicates an expected call of ListMetadata.
func (mr *MockITraceApplicationMockRecorder) ListMetadata(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListMetadata", reflect.TypeOf((*MockITraceApplication)(nil).ListMetadata), ctx, req)
}
...
func (m *MockITraceApplication) ListWorkspaceAnnotations(ctx context.Context, req *trace.ListWorkspaceAnnotationsRequest) (*trace.ListWorkspaceAnnotationsResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListWorkspaceAnnotations", ctx, req)
	ret0, _ := ret[0].(*trace.ListWorkspaceAnnotationsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListWorkspaceAnnotations indicates an expected call of ListWorkspaceAnnotations.
func (mr *MockITraceApplicationMockRecorder) ListWorkspaceAnnotations(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListWorkspaceAnnotations", reflect.TypeOf((*MockITraceApplication)(nil).ListWorkspaceAnnotations), ctx, req)
}
