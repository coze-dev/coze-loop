...
func (m *MockITraceApplication) GetThreadChat(ctx context.Context, req *trace.GetThreadChatRequest) (*trace.GetThreadChatResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetThreadChat", ctx, req)
	ret0, _ := ret[0].(*trace.GetThreadChatResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetThreadChat indicates an expected call of GetThreadChat.
func (mr *MockITraceApplicationMockRecorder) GetThreadChat(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetThreadChat", reflect.TypeOf((*MockITraceApplication)(nil).GetThreadChat), ctx, req)
}
...
func (m *MockITraceApplication) GetTraceChat(ctx context.Context, req *trace.GetTraceChatRequest) (*trace.GetTraceChatResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTraceChat", ctx, req)
	ret0, _ := ret[0].(*trace.GetTraceChatResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTraceChat indicates an expected call of GetTraceChat.
func (mr *MockITraceApplicationMockRecorder) GetTraceChat(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTraceChat", reflect.TypeOf((*MockITraceApplication)(nil).GetTraceChat), ctx, req)
}
