...
func NewMetricDefinitions() []entity.IMetricDefinition {
	return []entity.IMetricDefinition{general.NewGeneralTotalCountMetric(), general.NewGeneralFailRatioMetric(), general.NewGeneralModelTotalTokensMetric(), general.NewGeneralModelLatencyMetric(), general.NewGeneralModelFailRatioMetric(), general.NewGeneralToolTotalCountMetric(), general.NewGeneralToolLatencyMetric(), general.NewGeneralToolFailRatioMetric(), model.NewModelDurationMetric(), model.NewModelInputTokenCountMetric(), model.NewModelNamePieMetric(), model.NewModelQPMAllMetric(), model.NewModelQPMFailMetric(), model.NewModelQPMSuccessMetric(), model.NewModelQPSAllMetric(), model.NewModelQPSFailMetric(), model.NewModelQPSSuccessMetric(), model.NewModelSuccessRatioMetric(), model.NewModelSystemTokenCountMetric(), model.NewModelTokenCountMetric(), model.NewModelTokenCountPieMetric(), model.NewModelToolChoiceTokenCountMetric(), model.NewModelTPMMetric(), model.NewModelTPOTMetric(), model.NewModelTPSMetric(), model.NewModelTTFTMetric(), service3.NewServiceDurationMetric(), service3.NewServiceExecutionStepCountMetric(), service3.NewServiceMessageCountMetric(), service3.NewServiceQPMAllMetric(), service3.NewServiceQPMSuccessMetric(), service3.NewServiceQPMFailMetric(), service3.NewServiceQPSAllMetric(), service3.NewServiceQPSSuccessMetric(), service3.NewServiceQPSFailMetric(), service3.NewServiceSpanCountMetric(), service3.NewServiceSuccessRatioMetric(), service3.NewServiceTraceMetric(), service3.NewServiceUserCountMetric(), tool.NewToolDurationMetric(), tool.NewToolNamePieMetric(), tool.NewToolSuccessRatioMetric(), tool.NewToolTotalCountMetric()}
}
