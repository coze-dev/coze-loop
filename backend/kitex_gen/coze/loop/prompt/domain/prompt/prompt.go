...
type PromptDetail struct {
	...
	// skill调用配置
	SkillExecuteConfig *SkillExecuteConfig `thrift:"skill_execute_config,6,optional" frugal:"6,optional,SkillExecuteConfig" form:"skill_execute_config" json:"skill_execute_config,omitempty" query:"skill_execute_config"`
...
func (p *PromptDetail) ReadField6(iprot thrift.TProtocol) error {
...
func (p *PromptDetail) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetSkillExecuteConfig() {
		if err = oprot.WriteFieldBegin("skill_execute_config", thrift.STRUCT, 6); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *PromptDetail) DeepEqual(ano *PromptDetail) bool {
	...
	if !p.Field6DeepEqual(ano.SkillExecuteConfig) {
		return false
	}
...
func (p *PromptDetail) Field6DeepEqual(src *SkillExecuteConfig) bool {
