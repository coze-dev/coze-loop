...
type Filter struct {
	...
	// v2 精确匹配,非空 → WHERE model_key IN (?)
	ModelKeyList []string `thrift:"model_key_list,5,optional" frugal:"5,optional,list<string>" json:"model_key_list" form:"model_key_list" query:"model_key_list"`
}
...
type GetModelRequest struct {
	...
	// 与 model_id 并列;同时传以 model_id 为准(见 IManage.ResolveModel)
	ModelKey *string    `thrift:"model_key,6,optional" frugal:"6,optional,string" json:"model_key" form:"model_key" query:"model_key"`
	Base     *base.Base `thrift:"Base,255,optional" frugal:"255,optional,base.Base" form:"Base" json:"Base,omitempty" query:"Base"`
}
