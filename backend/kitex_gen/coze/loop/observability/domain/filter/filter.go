...
type FilterField struct {
	...
	Hidden     *bool          `thrift:"hidden,7,optional" frugal:"7,optional,bool" form:"hidden" json:"hidden,omitempty" query:"hidden"`
}
...
var FilterField_Hidden_DEFAULT bool

func (p *FilterField) GetHidden() (v bool) {
	if p == nil {
		return
	}
	if !p.IsSetHidden() {
		return FilterField_Hidden_DEFAULT
	}
	return *p.Hidden
}
...
func (p *FilterField) SetHidden(val *bool) {
	p.Hidden = val
}
...
func (p *FilterField) IsSetHidden() bool {
	return p.Hidden != nil
}
