...
func (p *Task) FastReadField13(buf []byte) (int, error) {
	offset := 0
...
func (p *Task) fastWriteField13(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetTaskRuns() {
...
func (p *Task) DeepCopy(s interface{}) error {
	...
	if src.TaskRuns != nil {
		p.TaskRuns = make([]*TaskRun, 0, len(src.TaskRuns))
		for _, elem := range src.TaskRuns {
			var _elem *TaskRun
			if elem != nil {
				_elem = &TaskRun{}
			...
			p.TaskRuns = append(p.TaskRuns, _elem)
		}
	}
...
func (p *EvaluationExperimentConfig) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EvaluationExperimentConfig[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *EvaluationExperimentConfig) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *EvaluationExperimentConfig) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *EvaluationExperimentConfig) FastReadField5(buf []byte) (int, error) {
	offset := 0
...
func (p *EvaluationExperimentConfig) FastReadField6(buf []byte) (int, error) {
	offset := 0
...
func (p *EvaluationExperimentConfig) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *EvaluationExperimentConfig) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
...
func (p *EvaluationExperimentConfig) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetItemConcurrencyCount() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I32, 1)
		offset += thrift.Binary.WriteI32(buf[offset:], *p.ItemConcurrencyCount)
	}
	return offset
}

func (p *EvaluationExperimentConfig) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetItemMaxRetryCount() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I32, 2)
		offset += thrift.Binary.WriteI32(buf[offset:], *p.ItemMaxRetryCount)
	}
	return offset
}
...
func (p *EvaluationExperimentConfig) fastWriteField5(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *EvaluationExperimentConfig) fastWriteField6(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *EvaluationExperimentConfig) field2Length() int {
	l := 0
	if p.IsSetItemMaxRetryCount() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.I32Length()
...
func (p *EvaluationExperimentConfig) field5Length() int {
	l := 0
	if p.IsSetSourceTargetVersion() {
		l += thrift.Binary.FieldBeginLength()
...
func (p *EvaluationExperimentConfig) field6Length() int {
	l := 0
	if p.IsSetFullEvalSetFieldMappings() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.ListBeginLength()
...
func (p *EvaluationExperimentConfig) DeepCopy(s interface{}) error {
	...
	if src.FullEvalSetFieldMappings != nil {
		p.FullEvalSetFieldMappings = make([]*EvaluateFieldMapping, 0, len(src.FullEvalSetFieldMappings))
		for _, elem := range src.FullEvalSetFieldMappings {
			...
			p.FullEvalSetFieldMappings = append(p.FullEvalSetFieldMappings, _elem)
		}
	}
...
func (p *SourceInfo) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SourceInfo[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}
...
func (p *SourceInfo) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *SourceInfo) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *SourceInfo) field1Length() int {
	l := 0
	if p.IsSetName() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.StringLengthNocopy(*p.Name)
...
func (p *SourceInfo) field2Length() int {
	l := 0
	if p.IsSetVersion() {
		l += thrift.Binary.FieldBeginLength()
...
func (p *SourceInfo) DeepCopy(s interface{}) error {
	src, ok := s.(*SourceInfo)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *TaskConfig) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *TaskConfig) FastReadField5(buf []byte) (int, error) {
	offset := 0
...
func (p *TaskConfig) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetEvaluationExperimentConfig() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 3)
		offset += p.EvaluationExperimentConfig.FastWriteNocopy(buf[offset:], w)
	}
	return offset
}
...
func (p *TaskConfig) fastWriteField5(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetIsWorkflowScheduled() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.BOOL, 5)
		offset += thrift.Binary.WriteBool(buf[offset:], *p.IsWorkflowScheduled)
	}
	return offset
}
...
func (p *TaskConfig) field3Length() int {
	l := 0
	if p.IsSetEvaluationExperimentConfig() {
		l += thrift.Binary.FieldBeginLength()
		l += p.EvaluationExperimentConfig.BLength()
	}
	return l
}

func (p *TaskConfig) field4Length() int {
	l := 0
	if p.IsSetSourceInfo() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.ListBeginLength()
...
func (p *TaskConfig) field5Length() int {
	l := 0
	if p.IsSetIsWorkflowScheduled() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.BoolLength()
...
func (p *TaskConfig) DeepCopy(s interface{}) error {
	...
	var _evaluationExperimentConfig *EvaluationExperimentConfig
	if src.EvaluationExperimentConfig != nil {
		_evaluationExperimentConfig = &EvaluationExperimentConfig{}
		if err := _evaluationExperimentConfig.DeepCopy(src.EvaluationExperimentConfig); err != nil {
			return err
		}
	}
	...
	if src.IsWorkflowScheduled != nil {
		tmp := *src.IsWorkflowScheduled
		p.IsWorkflowScheduled = &tmp
	}
...
func (p *AutoEvaluateConfig) DeepCopy(s interface{}) error {
	...
	if src.EvaluatorVersion != nil {
		...
		if *src.EvaluatorVersion != "" {
			tmp = kutils.StringDeepCopy(*src.EvaluatorVersion)
		}
		p.EvaluatorVersion = &tmp
	}
