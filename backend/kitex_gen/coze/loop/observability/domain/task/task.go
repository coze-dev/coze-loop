...
type Task struct {
	...
	// task runs
	TaskRuns []*TaskRun `thrift:"task_runs,13,optional" frugal:"13,optional,list<TaskRun>" form:"task_runs" json:"task_runs,omitempty" query:"task_runs"`
	// 基础信息
...
var Task_TaskRuns_DEFAULT []*TaskRun

func (p *Task) GetTaskRuns() (v []*TaskRun) {
	if p == nil {
		return
	}
	if !p.IsSetTaskRuns() {
		return Task_TaskRuns_DEFAULT
	}
	return p.TaskRuns
}
...
func (p *Task) SetTaskRuns(val []*TaskRun) {
	p.TaskRuns = val
}
...
func (p *Task) IsSetTaskRuns() bool {
	return p.TaskRuns != nil
}
...
func (p *Task) ReadField13(iprot thrift.TProtocol) error {
	...
	_field := make([]*TaskRun, 0, size)
	values := make([]TaskRun, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *Task) writeField13(oprot thrift.TProtocol) (err error) {
	if p.IsSetTaskRuns() {
		if err = oprot.WriteFieldBegin("task_runs", thrift.LIST, 13); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.TaskRuns)); err != nil {
			return err
		}
		for _, v := range p.TaskRuns {
...
func (p *Task) DeepEqual(ano *Task) bool {
	...
	if !p.Field13DeepEqual(ano.TaskRuns) {
		return false
	}
...
func (p *Task) Field13DeepEqual(src []*TaskRun) bool {

	if len(p.TaskRuns) != len(src) {
		return false
	}
	for i, v := range p.TaskRuns {
		_src := src[i]
		if !v.DeepEqual(_src) {
			return false
		}
...
type EvaluationExperimentConfig struct {
	...
	SourceTargetVersion      *string                 `thrift:"source_target_version,5,optional" frugal:"5,optional,string" json:"source_target_version" form:"source_target_version" query:"source_target_version"`
	FullEvalSetFieldMappings []*EvaluateFieldMapping `thrift:"full_eval_set_field_mappings,6,optional" frugal:"6,optional,list<EvaluateFieldMapping>" json:"full_eval_set_field_mappings" form:"full_eval_set_field_mappings" query:"full_eval_set_field_mappings"`
}
...
func (p *EvaluationExperimentConfig) InitDefault() {
}

var EvaluationExperimentConfig_ItemConcurrencyCount_DEFAULT int32

func (p *EvaluationExperimentConfig) GetItemConcurrencyCount() (v int32) {
	if p == nil {
		return
	}
	if !p.IsSetItemConcurrencyCount() {
		return EvaluationExperimentConfig_ItemConcurrencyCount_DEFAULT
	}
	return *p.ItemConcurrencyCount
}

var EvaluationExperimentConfig_ItemMaxRetryCount_DEFAULT int32

func (p *EvaluationExperimentConfig) GetItemMaxRetryCount() (v int32) {
	if p == nil {
		return
	}
	if !p.IsSetItemMaxRetryCount() {
		return EvaluationExperimentConfig_ItemMaxRetryCount_DEFAULT
	}
...
var EvaluationExperimentConfig_SourceTargetVersion_DEFAULT string

func (p *EvaluationExperimentConfig) GetSourceTargetVersion() (v string) {
	if p == nil {
		return
	}
	if !p.IsSetSourceTargetVersion() {
		return EvaluationExperimentConfig_SourceTargetVersion_DEFAULT
	}
	return *p.SourceTargetVersion
}

var EvaluationExperimentConfig_FullEvalSetFieldMappings_DEFAULT []*EvaluateFieldMapping

func (p *EvaluationExperimentConfig) GetFullEvalSetFieldMappings() (v []*EvaluateFieldMapping) {
	if p == nil {
		return
	}
	if !p.IsSetFullEvalSetFieldMappings() {
		return EvaluationExperimentConfig_FullEvalSetFieldMappings_DEFAULT
	}
	return p.FullEvalSetFieldMappings
}
...
func (p *EvaluationExperimentConfig) SetSourceTargetVersion(val *string) {
	p.SourceTargetVersion = val
}
func (p *EvaluationExperimentConfig) SetFullEvalSetFieldMappings(val []*EvaluateFieldMapping) {
	p.FullEvalSetFieldMappings = val
}
...
var fieldIDToName_EvaluationExperimentConfig = map[int16]string{
	...
	3: "source_target_id",
	4: "expt_template_id",
	5: "source_target_version",
	6: "full_eval_set_field_mappings",
}
...
func (p *EvaluationExperimentConfig) IsSetSourceTargetVersion() bool {
	return p.SourceTargetVersion != nil
}

func (p *EvaluationExperimentConfig) IsSetFullEvalSetFieldMappings() bool {
	return p.FullEvalSetFieldMappings != nil
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EvaluationExperimentConfig[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EvaluationExperimentConfig) ReadField1(iprot thrift.TProtocol) error {
...
func (p *EvaluationExperimentConfig) ReadField2(iprot thrift.TProtocol) error {
...
func (p *EvaluationExperimentConfig) ReadField5(iprot thrift.TProtocol) error {
...
func (p *EvaluationExperimentConfig) ReadField6(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
	...
	p.FullEvalSetFieldMappings = _field
	return nil
}

func (p *EvaluationExperimentConfig) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("EvaluationExperimentConfig"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *EvaluationExperimentConfig) writeField1(oprot thrift.TProtocol) (err error) {
	if p.IsSetItemConcurrencyCount() {
		if err = oprot.WriteFieldBegin("item_concurrency_count", thrift.I32, 1); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI32(*p.ItemConcurrencyCount); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *EvaluationExperimentConfig) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetItemMaxRetryCount() {
		if err = oprot.WriteFieldBegin("item_max_retry_count", thrift.I32, 2); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI32(*p.ItemMaxRetryCount); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *EvaluationExperimentConfig) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetSourceTargetVersion() {
		if err = oprot.WriteFieldBegin("source_target_version", thrift.STRING, 5); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *EvaluationExperimentConfig) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetFullEvalSetFieldMappings() {
		if err = oprot.WriteFieldBegin("full_eval_set_field_mappings", thrift.LIST, 6); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.FullEvalSetFieldMappings)); err != nil {
			return err
		}
		for _, v := range p.FullEvalSetFieldMappings {
			if err := v.Write(oprot); err != nil {
				return err
			}
		}
...
func (p *EvaluationExperimentConfig) String() string {
	...
	return fmt.Sprintf("EvaluationExperimentConfig(%+v)", *p)

}

func (p *EvaluationExperimentConfig) DeepEqual(ano *EvaluationExperimentConfig) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	}
	if !p.Field1DeepEqual(ano.ItemConcurrencyCount) {
		return false
	}
	...
	if !p.Field5DeepEqual(ano.SourceTargetVersion) {
		return false
	}
	if !p.Field6DeepEqual(ano.FullEvalSetFieldMappings) {
		return false
	}
	return true
}

func (p *EvaluationExperimentConfig) Field1DeepEqual(src *int32) bool {
...
func (p *EvaluationExperimentConfig) Field2DeepEqual(src *int32) bool {
...
func (p *EvaluationExperimentConfig) Field5DeepEqual(src *string) bool {
...
func (p *EvaluationExperimentConfig) Field6DeepEqual(src []*EvaluateFieldMapping) bool {

	if len(p.FullEvalSetFieldMappings) != len(src) {
		return false
	}
	for i, v := range p.FullEvalSetFieldMappings {
		_src := src[i]
		if !v.DeepEqual(_src) {
			return false
		}
...
type TaskConfig struct {
	...
	// 数据源信息
	SourceInfo []*SourceInfo `thrift:"source_info,4,optional" frugal:"4,optional,list<SourceInfo>" form:"source_info" json:"source_info,omitempty" query:"source_info"`
	// 工作流周期性任务
	IsWorkflowScheduled *bool `thrift:"is_workflow_scheduled,5,optional" frugal:"5,optional,bool" form:"is_workflow_scheduled" json:"is_workflow_scheduled,omitempty" query:"is_workflow_scheduled"`
}
...
var TaskConfig_EvaluationExperimentConfig_DEFAULT *EvaluationExperimentConfig

func (p *TaskConfig) GetEvaluationExperimentConfig() (v *EvaluationExperimentConfig) {
	if p == nil {
		return
	}
	if !p.IsSetEvaluationExperimentConfig() {
		return TaskConfig_EvaluationExperimentConfig_DEFAULT
	}
...
var TaskConfig_IsWorkflowScheduled_DEFAULT bool

func (p *TaskConfig) GetIsWorkflowScheduled() (v bool) {
	if p == nil {
		return
	}
	if !p.IsSetIsWorkflowScheduled() {
		return TaskConfig_IsWorkflowScheduled_DEFAULT
	}
	return *p.IsWorkflowScheduled
}
...
func (p *TaskConfig) SetIsWorkflowScheduled(val *bool) {
	p.IsWorkflowScheduled = val
}
...
func (p *TaskConfig) IsSetIsWorkflowScheduled() bool {
	return p.IsWorkflowScheduled != nil
}
...
func (p *TaskConfig) ReadField3(iprot thrift.TProtocol) error {
	_field := NewEvaluationExperimentConfig()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *TaskConfig) ReadField5(iprot thrift.TProtocol) error {
...
func (p *TaskConfig) writeField3(oprot thrift.TProtocol) (err error) {
	if p.IsSetEvaluationExperimentConfig() {
		if err = oprot.WriteFieldBegin("evaluation_experiment_config", thrift.STRUCT, 3); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.EvaluationExperimentConfig.Write(oprot); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *TaskConfig) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetSourceInfo() {
		if err = oprot.WriteFieldBegin("source_info", thrift.LIST, 4); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.SourceInfo)); err != nil {
			return err
		}
...
func (p *TaskConfig) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetIsWorkflowScheduled() {
		if err = oprot.WriteFieldBegin("is_workflow_scheduled", thrift.BOOL, 5); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteBool(*p.IsWorkflowScheduled); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *TaskConfig) DeepEqual(ano *TaskConfig) bool {
	...
	if !p.Field5DeepEqual(ano.IsWorkflowScheduled) {
		return false
	}
	return true
}
...
func (p *TaskConfig) Field4DeepEqual(src []*SourceInfo) bool {
	...
	if len(p.SourceInfo) != len(src) {
		return false
	}
	for i, v := range p.SourceInfo {
		_src := src[i]
		if !v.DeepEqual(_src) {
			return false
		}
...
func (p *TaskConfig) Field5DeepEqual(src *bool) bool {

	if p.IsWorkflowScheduled == src {
		return true
	} else if p.IsWorkflowScheduled == nil || src == nil {
		return false
	}
	if *p.IsWorkflowScheduled != *src {
		return false
...
type AutoEvaluateConfig struct {
	...
	EvaluatorVersion   *string                 `thrift:"evaluator_version,5,optional" frugal:"5,optional,string" form:"evaluator_version" json:"evaluator_version,omitempty" query:"evaluator_version"`
}
...
var AutoEvaluateConfig_ScoreWeight_DEFAULT float64

func (p *AutoEvaluateConfig) GetScoreWeight() (v float64) {
	if p == nil {
		return
	}
	if !p.IsSetScoreWeight() {
		return AutoEvaluateConfig_ScoreWeight_DEFAULT
	}
	return *p.ScoreWeight
}

var AutoEvaluateConfig_EvaluatorVersion_DEFAULT string

func (p *AutoEvaluateConfig) GetEvaluatorVersion() (v string) {
	if p == nil {
		return
	}
	if !p.IsSetEvaluatorVersion() {
		return AutoEvaluateConfig_EvaluatorVersion_DEFAULT
	}
...
func (p *AutoEvaluateConfig) SetScoreWeight(val *float64) {
	p.ScoreWeight = val
}
func (p *AutoEvaluateConfig) SetEvaluatorVersion(val *string) {
...
func (p *AutoEvaluateConfig) IsSetScoreWeight() bool {
	return p.ScoreWeight != nil
}

func (p *AutoEvaluateConfig) IsSetEvaluatorVersion() bool {
	return p.EvaluatorVersion != nil
}
...
func (p *AutoEvaluateConfig) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetEvaluatorVersion() {
		if err = oprot.WriteFieldBegin("evaluator_version", thrift.STRING, 5); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *AutoEvaluateConfig) DeepEqual(ano *AutoEvaluateConfig) bool {
	...
	if !p.Field5DeepEqual(ano.EvaluatorVersion) {
		return false
	}
	return true
}
...
func (p *AutoEvaluateConfig) Field4DeepEqual(src *float64) bool {
...
func (p *AutoEvaluateConfig) Field5DeepEqual(src *string) bool {

	if p.EvaluatorVersion == src {
		return true
	} else if p.EvaluatorVersion == nil || src == nil {
		return false
	}
