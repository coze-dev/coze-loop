...
func (p *kObservabilityOpenAPIServiceClient) CreateTaskOApi(ctx context.Context, req *openapi.CreateTaskOApiRequest, callOptions ...callopt.Option) (r *openapi.CreateTaskOApiResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateTaskOApi(ctx, req)
}

func (p *kObservabilityOpenAPIServiceClient) RunTaskOApi(ctx context.Context, req *openapi.RunTaskOApiRequest, callOptions ...callopt.Option) (r *openapi.RunTaskOApiResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
