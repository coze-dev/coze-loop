...
func (p *kObservabilityTraceServiceClient) CheckTaskName(ctx context.Context, req *trace.CheckTaskNameRequest, callOptions ...callopt.Option) (r *trace.CheckTaskNameResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CheckTaskName(ctx, req)
}

func (p *kObservabilityTraceServiceClient) CreateTask(ctx context.Context, req *trace.CreateTaskRequest, callOptions ...callopt.Option) (r *trace.CreateTaskResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.CreateTask(ctx, req)
}

func (p *kObservabilityTraceServiceClient) UpdateTask(ctx context.Context, req *trace.UpdateTaskRequest, callOptions ...callopt.Option) (r *trace.UpdateTaskResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UpdateTask(ctx, req)
}

func (p *kObservabilityTraceServiceClient) ListTasks(ctx context.Context, req *trace.ListTasksRequest, callOptions ...callopt.Option) (r *trace.ListTasksResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.ListTasks(ctx, req)
}

func (p *kObservabilityTraceServiceClient) GetTask(ctx context.Context, req *trace.GetTaskRequest, callOptions ...callopt.Option) (r *trace.GetTaskResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
