...
type CountEvaluationSetsRequest struct {
	...
	ItemCountGt *int64     `thrift:"item_count_gt,2,optional" frugal:"2,optional,i64" json:"item_count_gt" form:"item_count_gt" query:"item_count_gt"`
	Base        *base.Base `thrift:"Base,255,optional" frugal:"255,optional,base.Base" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
var CountEvaluationSetsRequest_ItemCountGt_DEFAULT int64

func (p *CountEvaluationSetsRequest) GetItemCountGt() (v int64) {
	if p == nil {
		return
	}
	if !p.IsSetItemCountGt() {
		return CountEvaluationSetsRequest_ItemCountGt_DEFAULT
	}
...
func (p *CountEvaluationSetsRequest) SetItemCountGt(val *int64) {
	p.ItemCountGt = val
}
...
func (p *CountEvaluationSetsRequest) IsSetItemCountGt() bool {
...
func (p *CountEvaluationSetsRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetItemCountGt() {
		if err = oprot.WriteFieldBegin("item_count_gt", thrift.I64, 2); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *CountEvaluationSetsRequest) DeepEqual(ano *CountEvaluationSetsRequest) bool {
	...
	if !p.Field2DeepEqual(ano.ItemCountGt) {
		return false
	}
	if !p.Field255DeepEqual(ano.Base) {
		return false
...
func (p *CountEvaluationSetsRequest) Field2DeepEqual(src *int64) bool {
...
var CountEvaluationSetsResponse_Count_DEFAULT int64

func (p *CountEvaluationSetsResponse) GetCount() (v int64) {
	if p == nil {
		return
	}
	if !p.IsSetCount() {
		return CountEvaluationSetsResponse_Count_DEFAULT
	}
	return *p.Count
}
...
func (p *CountEvaluationSetsResponse) SetCount(val *int64) {
	p.Count = val
}
...
func (p *CountEvaluationSetsResponse) IsSetCount() bool {
	return p.Count != nil
}
