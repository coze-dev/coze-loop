...
var EvaluatorOutputData_EvidenceArchive_DEFAULT *EvaluatorEvidenceArchive

func (p *EvaluatorOutputData) GetEvidenceArchive() (v *EvaluatorEvidenceArchive) {
	if p == nil {
		return
	}
	if !p.IsSetEvidenceArchive() {
		return EvaluatorOutputData_EvidenceArchive_DEFAULT
	}
...
func (p *EvaluatorOutputData) SetEvidenceArchive(val *EvaluatorEvidenceArchive) {
...
func (p *EvaluatorOutputData) IsSetEvidenceArchive() bool {
...
func (p *EvaluatorOutputData) ReadField13(iprot thrift.TProtocol) error {
...
func (p *EvaluatorOutputData) writeField13(oprot thrift.TProtocol) (err error) {
	if p.IsSetEvidenceArchive() {
...
func (p *EvaluatorOutputData) Field13DeepEqual(src *EvaluatorEvidenceArchive) bool {
