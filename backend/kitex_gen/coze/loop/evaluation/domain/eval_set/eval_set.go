...
type EvaluationSet struct {
	...
	// 创建评测集时使用的模版数据集 ID
	TemplateDatasetID *int64 `thrift:"template_dataset_id,23,optional" frugal:"23,optional,i64" json:"template_dataset_id" form:"template_dataset_id" query:"template_dataset_id"`
	// 版本信息
...
func (p *EvaluationSet) ReadField23(iprot thrift.TProtocol) error {
...
func (p *EvaluationSet) writeField23(oprot thrift.TProtocol) (err error) {
	if p.IsSetTemplateDatasetID() {
		if err = oprot.WriteFieldBegin("template_dataset_id", thrift.I64, 23); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *EvaluationSet) DeepEqual(ano *EvaluationSet) bool {
	...
	if !p.Field23DeepEqual(ano.TemplateDatasetID) {
		return false
	}
...
func (p *EvaluationSet) Field23DeepEqual(src *int64) bool {
...
var EvaluationSetVersion_SharedInfo_DEFAULT *common.SharedResourceInfo

func (p *EvaluationSetVersion) GetSharedInfo() (v *common.SharedResourceInfo) {
	if p == nil {
		return
	}
	if !p.IsSetSharedInfo() {
		return EvaluationSetVersion_SharedInfo_DEFAULT
	}
	return p.SharedInfo
}
...
func (p *EvaluationSetVersion) SetSharedInfo(val *common.SharedResourceInfo) {
	p.SharedInfo = val
}
...
func (p *EvaluationSetVersion) IsSetSharedInfo() bool {
	return p.SharedInfo != nil
}
...
func (p *EvaluationSetVersion) ReadField101(iprot thrift.TProtocol) error {
	_field := common.NewSharedResourceInfo()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *EvaluationSetVersion) writeField101(oprot thrift.TProtocol) (err error) {
	if p.IsSetSharedInfo() {
		if err = oprot.WriteFieldBegin("shared_info", thrift.STRUCT, 101); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *EvaluationSetVersion) Field101DeepEqual(src *common.SharedResourceInfo) bool {
...
type FieldSchema struct {
	...
	// 是否为不可修改的评测集模版列
	Locked *bool `thrift:"locked,60,optional" frugal:"60,optional,bool" form:"locked" json:"locked,omitempty" query:"locked"`
}
...
func (p *FieldSchema) ReadField60(iprot thrift.TProtocol) error {
...
func (p *FieldSchema) writeField60(oprot thrift.TProtocol) (err error) {
	if p.IsSetLocked() {
		if err = oprot.WriteFieldBegin("locked", thrift.BOOL, 60); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *FieldSchema) DeepEqual(ano *FieldSchema) bool {
	...
	if !p.Field60DeepEqual(ano.Locked) {
		return false
	}
	return true
}
...
func (p *FieldSchema) Field60DeepEqual(src *bool) bool {
