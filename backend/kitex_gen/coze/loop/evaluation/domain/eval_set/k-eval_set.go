...
func (p *EvaluationSet) FastReadField18(buf []byte) (int, error) {
	offset := 0
...
func (p *EvaluationSet) fastWriteField18(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetTag() {
...
func (p *EvaluationSet) field18Length() int {
	l := 0
	if p.IsSetTag() {
		l += thrift.Binary.FieldBeginLength()
