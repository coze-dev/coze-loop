...
type NotificationTriggerCondition struct {
	...
	Statuses []ExptStatus          `thrift:"statuses,2,optional" frugal:"2,optional,list<ExptStatus>" form:"statuses" json:"statuses,omitempty" query:"statuses"`
}
...
var NotificationTriggerCondition_Statuses_DEFAULT []ExptStatus

func (p *NotificationTriggerCondition) GetStatuses() (v []ExptStatus) {
	if p == nil {
		return
	}
	if !p.IsSetStatuses() {
...
func (p *NotificationTriggerCondition) SetStatuses(val []ExptStatus) {
	p.Statuses = val
}
...
func (p *NotificationTriggerCondition) ReadField2(iprot thrift.TProtocol) error {
	...
	_field := make([]ExptStatus, 0, size)
	for i := 0; i < size; i++ {

		var _elem ExptStatus
...
func (p *NotificationTriggerCondition) Field2DeepEqual(src []ExptStatus) bool {
...
type Experiment struct {
	...
	// 通知配置
	NotificationConfig *NotificationConfig `thrift:"notification_config,110,optional" frugal:"110,optional,NotificationConfig" form:"notification_config" json:"notification_config,omitempty" query:"notification_config"`
}
...
func (p *Experiment) writeField110(oprot thrift.TProtocol) (err error) {
	if p.IsSetNotificationConfig() {
		if err = oprot.WriteFieldBegin("notification_config", thrift.STRUCT, 110); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *Experiment) DeepEqual(ano *Experiment) bool {
	...
	if !p.Field110DeepEqual(ano.NotificationConfig) {
		return false
	}
	return true
}
