...
type Experiment struct {
	...
	// 通知配置
	NotificationConf *ExptNotificationConf `thrift:"notification_conf,72,optional" frugal:"72,optional,ExptNotificationConf" form:"notification_conf" json:"notification_conf,omitempty" query:"notification_conf"`
...
func (p *Experiment) ReadField72(iprot thrift.TProtocol) error {
...
func (p *Experiment) writeField72(oprot thrift.TProtocol) (err error) {
	if p.IsSetNotificationConf() {
		if err = oprot.WriteFieldBegin("notification_conf", thrift.STRUCT, 72); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *Experiment) DeepEqual(ano *Experiment) bool {
	...
	if !p.Field72DeepEqual(ano.NotificationConf) {
		return false
	}
...
func (p *Experiment) Field72DeepEqual(src *ExptNotificationConf) bool {
...
type WebhookNotificationConf struct {
	...
	Secret *string `thrift:"secret,3,optional" frugal:"3,optional,string" form:"secret" json:"secret,omitempty" query:"secret"`
}
...
var WebhookNotificationConf_Secret_DEFAULT string

func (p *WebhookNotificationConf) GetSecret() (v string) {
	if p == nil {
		return
	}
	if !p.IsSetSecret() {
		return WebhookNotificationConf_Secret_DEFAULT
	}
	return *p.Secret
}
...
func (p *WebhookNotificationConf) SetSecret(val *string) {
	p.Secret = val
}
...
func (p *WebhookNotificationConf) IsSetSecret() bool {
	return p.Secret != nil
}
...
func (p *WebhookNotificationConf) Field3DeepEqual(src *string) bool {
