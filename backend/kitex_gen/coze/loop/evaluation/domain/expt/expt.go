...
type Experiment struct {
	...
	EnableWeightedScore *bool            `thrift:"enable_weighted_score,52,optional" frugal:"52,optional,bool" form:"enable_weighted_score" json:"enable_weighted_score,omitempty" query:"enable_weighted_score"`
}
...
func (p *Experiment) writeField52(oprot thrift.TProtocol) (err error) {
	if p.IsSetEnableWeightedScore() {
		if err = oprot.WriteFieldBegin("enable_weighted_score", thrift.BOOL, 52); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *Experiment) DeepEqual(ano *Experiment) bool {
	...
	if !p.Field52DeepEqual(ano.EnableWeightedScore) {
		return false
	}
	return true
}
...
func (p *Experiment) Field52DeepEqual(src *bool) bool {
...
type EvaluatorFieldMapping struct {
	...
	EvaluatorID        *int64          `thrift:"evaluator_id,4,optional" frugal:"4,optional,i64" json:"evaluator_id" form:"evaluator_id" query:"evaluator_id"`
...
func (p *EvaluatorFieldMapping) ReadField5(iprot thrift.TProtocol) error {
...
func (p *EvaluatorFieldMapping) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetEvaluatorID() {
		if err = oprot.WriteFieldBegin("evaluator_id", thrift.I64, 4); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *EvaluatorFieldMapping) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetVersion() {
...
func (p *EvaluatorFieldMapping) DeepEqual(ano *EvaluatorFieldMapping) bool {
	...
	if !p.Field4DeepEqual(ano.EvaluatorID) {
		return false
	}
...
func (p *EvaluatorFieldMapping) Field4DeepEqual(src *int64) bool {
...
func (p *EvaluatorFieldMapping) Field5DeepEqual(src *string) bool {
