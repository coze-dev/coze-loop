...
func (p *Experiment) fastWriteField52(buf []byte, w thrift.NocopyWriter) int {
	...
	if p.IsSetEnableWeightedScore() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.BOOL, 52)
...
func (p *EvaluatorFieldMapping) FastReadField5(buf []byte) (int, error) {
	offset := 0
...
func (p *EvaluatorFieldMapping) fastWriteField5(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetVersion() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRING, 5)
...
func (p *EvaluatorFieldMapping) field5Length() int {
	l := 0
	if p.IsSetVersion() {
		l += thrift.Binary.FieldBeginLength()
