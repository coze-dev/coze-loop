...
func (p *ExptAggregateResult_) FastReadField20(buf []byte) (int, error) {
	offset := 0
...
func (p *ExptAggregateResult_) fastWriteField20(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *ExptAggregateResult_) field20Length() int {
	l := 0
	if p.IsSetEvalSetColumnResults() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.ListBeginLength()
...
func (p *ExptAggregateResult_) DeepCopy(s interface{}) error {
	...
	if src.EvalSetColumnResults != nil {
		p.EvalSetColumnResults = make([]*EvalSetColumnAggregateResult_, 0, len(src.EvalSetColumnResults))
		for _, elem := range src.EvalSetColumnResults {
			var _elem *EvalSetColumnAggregateResult_
			if elem != nil {
				_elem = &EvalSetColumnAggregateResult_{}
				if err := _elem.DeepCopy(elem); err != nil {
					return err
				}
			}

			p.EvalSetColumnResults = append(p.EvalSetColumnResults, _elem)
		}
	}
