...
func (p *EvaluatorIDVersionPair) IsValid() error {
	return nil
}
func (p *BatchGetEvaluatorVersionIDsRequest) IsValid() error {
	if p.Base != nil {
		if err := p.Base.IsValid(); err != nil {
			return fmt.Errorf("field Base not valid, %w", err)
		}
...
func (p *BatchGetEvaluatorVersionIDsResponse) IsValid() error {
	if p.BaseResp != nil {
		if err := p.BaseResp.IsValid(); err != nil {
			return fmt.Errorf("field BaseResp not valid, %w", err)
		}
