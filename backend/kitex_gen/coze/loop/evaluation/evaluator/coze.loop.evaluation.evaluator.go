...
type UpdateEvaluatorDraftRequest struct {
	...
	Tags             map[evaluator.EvaluatorTagKey][]string `thrift:"tags,5,optional" frugal:"5,optional,map<string:list<string>>" json:"tags" form:"tags" `
	// 是否预置评估器
	Builtin *bool      `thrift:"builtin,6,optional" frugal:"6,optional,bool" json:"builtin" form:"builtin" `
	Base    *base.Base `thrift:"Base,255,optional" frugal:"255,optional,base.Base" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
var UpdateEvaluatorDraftRequest_Tags_DEFAULT map[evaluator.EvaluatorTagKey][]string

func (p *UpdateEvaluatorDraftRequest) GetTags() (v map[evaluator.EvaluatorTagKey][]string) {
	if p == nil {
		return
	}
	if !p.IsSetTags() {
		return UpdateEvaluatorDraftRequest_Tags_DEFAULT
	}
	return p.Tags
}

var UpdateEvaluatorDraftRequest_Builtin_DEFAULT bool

func (p *UpdateEvaluatorDraftRequest) GetBuiltin() (v bool) {
	if p == nil {
		return
	}
	if !p.IsSetBuiltin() {
		return UpdateEvaluatorDraftRequest_Builtin_DEFAULT
	}
	return *p.Builtin
}
...
func (p *UpdateEvaluatorDraftRequest) SetTags(val map[evaluator.EvaluatorTagKey][]string) {
	p.Tags = val
}
func (p *UpdateEvaluatorDraftRequest) SetBuiltin(val *bool) {
	p.Builtin = val
}
...
func (p *UpdateEvaluatorDraftRequest) IsSetTags() bool {
	return p.Tags != nil
}

func (p *UpdateEvaluatorDraftRequest) IsSetBuiltin() bool {
	return p.Builtin != nil
}
...
func (p *UpdateEvaluatorDraftRequest) ReadField5(iprot thrift.TProtocol) error {
...
func (p *UpdateEvaluatorDraftRequest) ReadField6(iprot thrift.TProtocol) error {
...
func (p *UpdateEvaluatorDraftRequest) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetTags() {
...
func (p *UpdateEvaluatorDraftRequest) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetBuiltin() {
...
func (p *UpdateEvaluatorDraftRequest) Field5DeepEqual(src map[evaluator.EvaluatorTagKey][]string) bool {
...
func (p *UpdateEvaluatorDraftRequest) Field6DeepEqual(src *bool) bool {
...
type PublishBuiltinEvaluatorRequest struct {
	...
	// 上下架操作类型
	OperationType *evaluator.OperationType `thrift:"operation_type,4,optional" frugal:"4,optional,string" json:"operation_type" form:"operation_type" `
	Base          *base.Base               `thrift:"Base,255,optional" frugal:"255,optional,base.Base" form:"Base" json:"Base,omitempty" query:"Base"`
}
...
var PublishBuiltinEvaluatorRequest_WorkspaceID_DEFAULT int64

func (p *PublishBuiltinEvaluatorRequest) GetWorkspaceID() (v int64) {
	if p == nil {
		return
	}
	if !p.IsSetWorkspaceID() {
		return PublishBuiltinEvaluatorRequest_WorkspaceID_DEFAULT
	}
	return *p.WorkspaceID
}
...
func (p *PublishBuiltinEvaluatorRequest) SetWorkspaceID(val *int64) {
	p.WorkspaceID = val
}
...
func (p *PublishBuiltinEvaluatorRequest) IsSetWorkspaceID() bool {
	return p.WorkspaceID != nil
}
...
func (p *PublishBuiltinEvaluatorRequest) ReadField4(iprot thrift.TProtocol) error {
...
func (p *PublishBuiltinEvaluatorRequest) writeField4(oprot thrift.TProtocol) (err error) {
	if p.IsSetOperationType() {
		if err = oprot.WriteFieldBegin("operation_type", thrift.STRING, 4); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *PublishBuiltinEvaluatorRequest) DeepEqual(ano *PublishBuiltinEvaluatorRequest) bool {
	...
	if !p.Field4DeepEqual(ano.OperationType) {
		return false
	}
	if !p.Field255DeepEqual(ano.Base) {
		return false
...
func (p *PublishBuiltinEvaluatorRequest) Field3DeepEqual(src *int64) bool {
...
func (p *PublishBuiltinEvaluatorRequest) Field4DeepEqual(src *evaluator.OperationType) bool {
