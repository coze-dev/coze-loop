...
func (p *ReportEvaluatorInvokeProgressRequest) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ReportEvaluatorInvokeProgressRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
RequiredFieldNotSetError:
	return offset, thrift.NewProtocolException(thrift.INVALID_DATA, fmt.Sprintf("required field %s is not set", fieldIDToName_ReportEvaluatorInvokeProgressRequest[fieldId]))
}

func (p *ReportEvaluatorInvokeProgressRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ReportEvaluatorInvokeProgressRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *ReportEvaluatorInvokeProgressRequest) FastReadField3(buf []byte) (int, error) {
	offset := 0
	...
	_field := make([]*evaluator.EvaluatorProgressMessage, 0, size)
	values := make([]evaluator.EvaluatorProgressMessage, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
		if l, err := _elem.FastRead(buf[offset:]); err != nil {
	...
	p.ProgressMessages = _field
	return offset, nil
}

func (p *ReportEvaluatorInvokeProgressRequest) FastReadField255(buf []byte) (int, error) {
	offset := 0
	_field := base.NewBase()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *ReportEvaluatorInvokeProgressRequest) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *ReportEvaluatorInvokeProgressRequest) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
		offset += p.fastWriteField2(buf[offset:], w)
...
func (p *ReportEvaluatorInvokeProgressRequest) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
...
func (p *ReportEvaluatorInvokeProgressRequest) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 1)
	offset += thrift.Binary.WriteI64(buf[offset:], p.WorkspaceID)
	return offset
...
func (p *ReportEvaluatorInvokeProgressRequest) fastWriteField2(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.I64, 2)
	offset += thrift.Binary.WriteI64(buf[offset:], p.InvokeID)
	return offset
...
func (p *ReportEvaluatorInvokeProgressRequest) fastWriteField3(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetProgressMessages() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.LIST, 3)
		listBeginOffset := offset
		offset += thrift.Binary.ListBeginLength()
		var length int
		for _, v := range p.ProgressMessages {
			length++
			offset += v.FastWriteNocopy(buf[offset:], w)
		}
		thrift.Binary.WriteListBegin(buf[listBeginOffset:], thrift.STRUCT, length)
...
func (p *ReportEvaluatorInvokeProgressRequest) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetBase() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 255)
		offset += p.Base.FastWriteNocopy(buf[offset:], w)
...
func (p *ReportEvaluatorInvokeProgressRequest) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.I64Length()
	return l
...
func (p *ReportEvaluatorInvokeProgressRequest) field2Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += thrift.Binary.I64Length()
	return l
...
func (p *ReportEvaluatorInvokeProgressRequest) field3Length() int {
	l := 0
	if p.IsSetProgressMessages() {
		l += thrift.Binary.FieldBeginLength()
		l += thrift.Binary.ListBeginLength()
...
func (p *ReportEvaluatorInvokeProgressRequest) field255Length() int {
	l := 0
	if p.IsSetBase() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Base.BLength()
...
func (p *ReportEvaluatorInvokeProgressRequest) DeepCopy(s interface{}) error {
	src, ok := s.(*ReportEvaluatorInvokeProgressRequest)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
	...
	if src.ProgressMessages != nil {
		p.ProgressMessages = make([]*evaluator.EvaluatorProgressMessage, 0, len(src.ProgressMessages))
		for _, elem := range src.ProgressMessages {
			var _elem *evaluator.EvaluatorProgressMessage
			if elem != nil {
				_elem = &evaluator.EvaluatorProgressMessage{}
				if err := _elem.DeepCopy(elem); err != nil {
					return err
				}
			}

			p.ProgressMessages = append(p.ProgressMessages, _elem)
		}
	}
...
func (p *ReportEvaluatorInvokeProgressResponse) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ReportEvaluatorInvokeProgressResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *ReportEvaluatorInvokeProgressResponse) FastReadField255(buf []byte) (int, error) {
	offset := 0
	_field := base.NewBaseResp()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
func (p *ReportEvaluatorInvokeProgressResponse) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *ReportEvaluatorInvokeProgressResponse) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField255(buf[offset:], w)
	}
...
func (p *ReportEvaluatorInvokeProgressResponse) BLength() int {
	l := 0
	if p != nil {
		l += p.field255Length()
	}
...
func (p *ReportEvaluatorInvokeProgressResponse) fastWriteField255(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 255)
	offset += p.BaseResp.FastWriteNocopy(buf[offset:], w)
	return offset
...
func (p *ReportEvaluatorInvokeProgressResponse) field255Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.BaseResp.BLength()
	return l
...
func (p *ReportEvaluatorInvokeProgressResponse) DeepCopy(s interface{}) error {
	src, ok := s.(*ReportEvaluatorInvokeProgressResponse)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
	_field := NewReportEvaluatorInvokeProgressRequest()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
	} else {
		offset += l
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], w)
	}
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) BLength() int {
	l := 0
	if p != nil {
		l += p.field1Length()
	}
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) fastWriteField1(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 1)
	offset += p.Req.FastWriteNocopy(buf[offset:], w)
	return offset
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) field1Length() int {
	l := 0
	l += thrift.Binary.FieldBeginLength()
	l += p.Req.BLength()
	return l
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) DeepCopy(s interface{}) error {
	src, ok := s.(*EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _req *ReportEvaluatorInvokeProgressRequest
	if src.Req != nil {
		_req = &ReportEvaluatorInvokeProgressRequest{}
		if err := _req.DeepCopy(src.Req); err != nil {
			return err
		}
	}
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) FastRead(buf []byte) (int, error) {
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
}

func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
	_field := NewReportEvaluatorInvokeProgressResponse()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
	} else {
		offset += l
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) FastWrite(buf []byte) int {
	return p.FastWriteNocopy(buf, nil)
}

func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) FastWriteNocopy(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], w)
	}
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) BLength() int {
	l := 0
	if p != nil {
		l += p.field0Length()
	}
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) fastWriteField0(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += thrift.Binary.WriteFieldBegin(buf[offset:], thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], w)
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += thrift.Binary.FieldBeginLength()
		l += p.Success.BLength()
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) DeepCopy(s interface{}) error {
	src, ok := s.(*EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult)
	if !ok {
		return fmt.Errorf("%T's type not matched %T", s, p)
	}

	var _success *ReportEvaluatorInvokeProgressResponse
	if src.Success != nil {
		_success = &ReportEvaluatorInvokeProgressResponse{}
		if err := _success.DeepCopy(src.Success); err != nil {
			return err
		}
	}
...
func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *EvaluationOpenAPIServiceReportEvaluatorInvokeProgressResult) GetResult() interface{} {
	return p.Success
}
