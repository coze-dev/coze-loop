...
func (p *kEvaluationOpenAPIServiceClient) ReportEvaluatorInvokeProgress(ctx context.Context, req *openapi.ReportEvaluatorInvokeProgressRequest, callOptions ...callopt.Option) (r *openapi.ReportEvaluatorInvokeProgressResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
