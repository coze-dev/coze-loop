...
func (p *EvaluatorOutputData) FastReadField13(buf []byte) (int, error) {
	offset := 0
...
func (p *EvaluatorOutputData) fastWriteField13(buf []byte, w thrift.NocopyWriter) int {
	offset := 0
...
func (p *EvaluatorOutputData) field13Length() int {
	l := 0
	if p.IsSetEvidenceArchive() {
		l += thrift.Binary.FieldBeginLength()
