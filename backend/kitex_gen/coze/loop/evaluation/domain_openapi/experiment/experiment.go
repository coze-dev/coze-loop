...
type Experiment struct {
	...
	// 通知配置
	NotificationConf *ExptNotificationConf `thrift:"notification_conf,63,optional" frugal:"63,optional,ExptNotificationConf" form:"notification_conf" json:"notification_conf,omitempty" query:"notification_conf"`
...
func (p *Experiment) writeField63(oprot thrift.TProtocol) (err error) {
	if p.IsSetNotificationConf() {
		if err = oprot.WriteFieldBegin("notification_conf", thrift.STRUCT, 63); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *Experiment) DeepEqual(ano *Experiment) bool {
	...
	if !p.Field63DeepEqual(ano.NotificationConf) {
		return false
	}
...
func (p *Experiment) Field63DeepEqual(src *ExptNotificationConf) bool {
...
type ExptTemplate struct {
	...
	NotificationConf        *ExptNotificationConf `thrift:"notification_conf,6,optional" frugal:"6,optional,ExptNotificationConf" form:"notification_conf" json:"notification_conf,omitempty" query:"notification_conf"`
	BaseInfo                *common.BaseInfo      `thrift:"base_info,100,optional" frugal:"100,optional,common.BaseInfo" form:"base_info" json:"base_info,omitempty" query:"base_info"`
}
...
func (p *ExptTemplate) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetNotificationConf() {
		if err = oprot.WriteFieldBegin("notification_conf", thrift.STRUCT, 6); err != nil {
			goto WriteFieldBeginError
		}
		if err := p.NotificationConf.Write(oprot); err != nil {
			return err
...
func (p *ExptTemplate) DeepEqual(ano *ExptTemplate) bool {
	...
	if !p.Field6DeepEqual(ano.NotificationConf) {
		return false
	}
	if !p.Field100DeepEqual(ano.BaseInfo) {
		return false
...
func (p *ExptTemplate) Field6DeepEqual(src *ExptNotificationConf) bool {
