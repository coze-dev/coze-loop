...
type ModelConfig struct {
	...
	MaxTokens   *int32   `thrift:"max_tokens,3,optional" frugal:"3,optional,i32" form:"max_tokens" json:"max_tokens,omitempty" query:"max_tokens"`
...
func (p *ModelConfig) Field1DeepEqual(src *string) bool {
