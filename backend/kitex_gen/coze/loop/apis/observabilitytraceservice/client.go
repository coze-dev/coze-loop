...
type Client interface {
	...
	GetAdjacentTrace(ctx context.Context, req *trace.GetAdjacentTraceRequest, callOptions ...callopt.Option) (r *trace.GetAdjacentTraceResponse, err error)
...
func (p *kObservabilityTraceServiceClient) ListWorkspaceAnnotations(ctx context.Context, req *trace.ListWorkspaceAnnotationsRequest, callOptions ...callopt.Option) (r *trace.ListWorkspaceAnnotationsResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
...
func (p *kObservabilityTraceServiceClient) GetAdjacentTrace(ctx context.Context, req *trace.GetAdjacentTraceRequest, callOptions ...callopt.Option) (r *trace.GetAdjacentTraceResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetAdjacentTrace(ctx, req)
}
...
func (p *kObservabilityTraceServiceClient) GetColumnExtractConfig(ctx context.Context, req *trace.GetColumnExtractConfigRequest, callOptions ...callopt.Option) (r *trace.GetColumnExtractConfigResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
